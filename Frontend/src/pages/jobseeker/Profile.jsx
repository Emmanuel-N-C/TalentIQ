    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
      <div className="max-w-7xl mx-auto p-4 sm:p-6">
        ...
        <div className="mb-6 sm:mb-8">
          ...
          <p className="text-slate-400 text-sm sm:text-base">Manage your personal information and settings</p>
        </div>

        {/* Profile Completion Alert for OAuth Users */}
        {needsProfileCompletion && (
          <div className="mb-4 sm:mb-6 bg-yellow-500/10 border border-yellow-500/30 rounded-xl p-3 sm:p-4 flex items-start gap-2 sm:gap-3">
            <AlertCircle className="w-4 h-4 sm:w-5 sm:h-5 text-yellow-400 flex-shrink-0 mt-0.5" />
            <div>
              <p className="text-yellow-300 font-medium mb-1 text-sm sm:text-base">
        ...
        <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-xl p-4 sm:p-6 mb-4 sm:mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-4">
            <div>
              <p className="text-xs sm:text-sm text-slate-400">Account Status</p>
              <p className="text-white font-medium flex items-center gap-2 mt-1 text-sm sm:text-base">
          ...
          <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-xl p-4 sm:p-6 mb-4 sm:mb-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
              ...
              <div className="bg-slate-900/50 rounded-lg p-4 sm:p-6 border border-slate-700">
                ...
                <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-2 sm:p-3 mb-4">
                ...
                <button
                  ...
                  disabled={isDeleting}
                  className="w-full px-3 sm:px-4 py-2 bg-red-600 hover:bg-red-700 disabled:bg-red-800 disabled:cursor-not-allowed text-white rounded-lg transition-colors duration-200 flex items-center justify-center gap-2 text-sm sm:text-base"
                >
                  {isDeleting ? (
                    <>
