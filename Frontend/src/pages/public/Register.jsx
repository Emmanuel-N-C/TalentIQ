                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <select
                        ...
                        disabled={loading}
                        className="w-full pl-11 pr-10 py-3 bg-slate-900/50 border border-slate-600 rounded-lg text-white focus:outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 disabled:opacity-50 disabled:cursor-not-allowed text-sm sm:text-base appearance-none cursor-pointer relative z-0"
                        style={{
